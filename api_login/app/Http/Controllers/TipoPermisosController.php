        ...
        if ($this->AccessToken($data['token'], $data['credenciales'], $Usr, $errors)) {
            ...
            if (!$validator->fails()) {
                ...
                try {
                    ...
                    $row = DB::table('tipos_permiso')
                        ->select('tipos_permiso.*')
                        ->where('tipos_permiso.id', '=', $id_tipo_permiso)
                        ->first();
        ...
        if ($this->AccessToken($data['token'], $data['credenciales'], $Usr, $errors)) {
            ...
            if (!$validator->fails()) {
                ...
                try {
                    ...
                    $insertId = DB::table('tipos_permiso')->insertGetId([
